...
class AuthControllers {
    ...
    getTokensByRefreshTokensHandlers = async (req, res) => {
        const reqBody = req.body;
        const result = Result.pipe(validateRequest("Users:refresh-token", reqBody, "Refresh token details do not mee the required validation criteria"), Result.andThen((refreshTokenData) => {
