...
class UserControllers {
    updateUserByIdHandlers = async (req: Request, res: Response) => {
        ...
        const result = await Result.pipe(
            validateRequest("Users:update", reqBody, "User update details do not meet the required validation criteria"),
            Result.andThen(async (validatedUserData) => {
